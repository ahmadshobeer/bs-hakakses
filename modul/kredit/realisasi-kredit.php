            ...
            <div class="form-group row">
              <div class="col-md-4 col-sm-9 col-xs-12">
                ...
                <select class="form-control" name="ao" id="ao" required>
                  ...
                  <?php 
                  $sqlquery="SELECT x.nama_lengkap, waoaoco FROM profile_karyawan.tbl_datapribadi X JOIN mis.tbl_ao Y ON x.id_datapribadi=y.id_datapribadi WHERE waodept='LEN' ORDER BY x.nama_lengkap ASC";
                  $runsql=mysqli_query($conn_mis,$sqlquery);
                  while($varData=mysqli_fetch_array($runsql)){
    ...
    $(document).ready(function(){
      ...
      function fetch_data(is_date_search, tgl='', tgl2='', prod='', cab='', ao='')
      {
        var dataTable = $('#lapdata').DataTable({
          ...
          "order" : [],
          "ajax" : {
            url:"../api/mis/pinjaman/realisasi_pinjaman.php",
            type:"POST",
            data:{
