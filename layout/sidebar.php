...
<?php
		//load menu utama
		$sql_menu = mysqli_query($conn,"SELECT * from  tbl_menu_group b
						                    where  b.level='1' and b.show='Y'  order by b.code_menu asc");
              ...
              ";
				...
				<li class='nav-item has-treeview $show_sub'>
					...
					<ul class='nav nav-treeview'>";
						//load sub menu
						$sql_sub = mysqli_query($conn,"SELECT * from  tbl_menu_group b
						                    WHERE  b.level='2' and
						b.parent='$menu[code_menu]' and b.show='Y' order by b.code_menu asc");						
						while ($sub=mysqli_fetch_array($sql_sub)){
							...
							if (($_GET['module']==$sub['module']) or ($replace==$sub['module']))
								...
								$active_sub = "";
							//echo "<a class='collapse-item $active_sub' href='?modul=$sub[modul]'>$sub[desk_menu]</a>";
